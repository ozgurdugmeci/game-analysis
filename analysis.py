...
try: 
 ...
 '<< Click on the bars to view the stats of the players on the court >> On mobile, use zoom in and pan options from graph menu for a better monitoring.'
 if secy== 'Home Team':
 ...
 try:
  ...
  finally produced ' + str(tot) + ' contribution points, ending their time with result: ' +son[0]
